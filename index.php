...
<html lang="en">
  <head>
    <title>Winsway Transport Ltd.</title>
    <meta charset="utf-8">
        ...
        <div class="row align-items-center justify-content-center">
          ...
          <div class="text-left">
            ...
            <nav class="site-navigation position-relative" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                <li><a href="#portfolio-section" class="nav-link">Partners</a></li>
      ...
      <div class="container">
        <div class="row ">
          ...
          <div class="col-lg-4 order-1 order-lg-2 mb-4 mb-lg-0">
            ...
            <img src="images/truck.jpg" alt="Image" class="img-fluid" height="300" width="200">
            </div>
          </div>
    ...
    <section class="site-section bg-dark">
      <div class="container">
        ...
        <div class="owl-carousel slide-one-item">
          ...
          <div class="slide">
            <blockquote>
              <p>Work efficent staff and operators. Stern and committed to deadlines </p>
              <p><cite>&mdash; abc</cite></p>
            </blockquote>
          </div>
          <div class="slide">
            <blockquote>
              <p>Certified for hizzardious substances delivery.</p>
              <p><cite>&mdash; Tarwinz Niche Technology Vision</cite></p>
            </blockquote>
          </div>
        </div>
      </div>
    ...
    <section class="site-section"  id="clients-section">
      <div class="container">
        <div class="row">
          ...
          <div class="col-6 col-sm-6 col-md-4 col-lg-6 text-center">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <p>
            ...
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |  <i class="icon-heart text-danger" aria-hidden="true"></i> designed by <a href="mailto:Ggursharankaur@gmail.com">Gursharan Kaur</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
            </div>
        </div>
